...
import { WebviewState } from '../types/webview';

export function getChatWebviewContent(webview: vscode.Webview, extensionUri: vscode.Uri, initialState: WebviewState): string {
