...
export class GitIntegration {
     ...
     */
    public async generatePullRequestDescription(diff: string, branchName: string): Promise<string | null> {
        const prompt = `
     ...
     */
    public async summarizeCodeReview(comments: string): Promise<string | null> {
        const prompt = `
     ...
     */
    public async suggestBranchName(taskDescription: string): Promise<string | null> {
        const prompt = `
